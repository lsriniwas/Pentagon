...
const Dashboard = () => {
    ...
    console.log("12",data.jobs_applied)
                ...
                <div>
                    <Card style={{ width: "700px" }} type="inner" title="Jobs for You" extra={<a href="#">More</a>}>
                        <Tabs defaultActiveKey="1" onChange={callback} tabBarGutter={70}>
                            <TabPane tab="Matched" key="1"></TabPane>
                            <TabPane tab="Saved" key="2"></TabPane>
                            <TabPane tab="Applied" key="3"></TabPane>
                        </Tabs></Card>
                    <Card style={{ width: "700px", textAlign:"center", marginTop:"20px" }}>
                    <img src={process.env.PUBLIC_URL + '/warn.png'} alt="" srcset="" height="70px"/><br/>
                    ...
                    <Card style={{ width: 350 }}>
                        <div >
                            <div style={{ display: "flex" }} >
                                <div style={{ width: "60px", height: "60px", borderRadius: "35px", textAlign: "center", fontSize: "30px", fontWeight: "600", backgroundColor: "#4B30BD", color: "white" }} >
