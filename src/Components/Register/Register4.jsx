...
const Register4 = props => {
    ...
    return (
        <div style={{ position:'relative', height: "500px", width: "782px", backgroundImage: `url('back1.jpg')`, margin: "auto", marginTop: "50px", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", height: "30px", position: 'absolute', }}>
                ...
                {
                    submitted && <button style={{ marginLeft: "30px", backgroundColor: "white", padding: "5px", borderRadius: "5px", border: "1px solid gray" }}>NEXT</button>}
                {
                    experienced && <button style={{ marginLeft: "570px", backgroundColor: "white", padding: "5px", borderRadius: "5px", border: "1px solid gray" }} onClick={() => handleNext("fresher")}>NEXT</button>}
            </div>
        </div>
    )
}
