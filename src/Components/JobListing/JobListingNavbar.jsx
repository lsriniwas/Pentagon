...
import styles from '../../Styles/JobListingNavbar.module.css';
...
const JobListingNavbar = (props) => {const history = useHistory()
    ...
    return (
        ...
        <div className={styles.navbar_wrapper} >
            ...
            <img src={process.env.PUBLIC_URL + '/cart2.png'} alt="" srcset="" height="30px" style={{marginRight:"20px"}}/>
                <img src={process.env.PUBLIC_URL + '/bell2.png'} alt="" srcset="" height="30px"/>

            <Dropdown overlay={menu} >
                <a className="ant-dropdown-link" onClick={e => e.preventDefault()} style={{border:"1px solid black", padding:"5px", color:"black", width:"max-content", fontSize:"larger", marginRight:"120px", marginLeft:"40px"}}>
...
export default JobListingNavbar
